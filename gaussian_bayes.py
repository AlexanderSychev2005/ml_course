...
r1 = 0.8 # корреляция 1 набора данных
D1 = 1.0 # дисперсия 1 набора данных

mean1 = [0, -3] # среднее 1 набора данных
V1 = [[D1, D1 * r1], [D1 * r1, D1]] # ковариационная матрица 1 набора данных


r2 = 0.7 # корреляция 2 набора данных
D2 = 2.0
mean2 = [0, 3]
...
N = 1000
x1 = np.random.multivariate_normal(mean1, V1, N).T # многомерное нормальное распределение
